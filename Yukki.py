...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
            await idk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
            await ydk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
            await wdk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
            await hdk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
            await sdk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
            await adk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
            await bdk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
            await cdk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
            await ddk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
            await edk(functions.channels.JoinChannelRequest(channel="@sohbetmuhabbetw"))
